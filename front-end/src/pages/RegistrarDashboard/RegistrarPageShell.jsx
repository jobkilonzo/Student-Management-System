...
const RegistrarPageShell = ({
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#e0f2fe,_#f0f9ff_34%,_#f8fafc_78%)] p-4 sm:p-6">
      <div className="mx-auto max-w-7xl space-y-8">
        <div className="rounded-[32px] border border-sky-100 bg-white/90 px-4 py-5 shadow-[0_20px_60px_-40px_rgba(14,116,144,0.45)] backdrop-blur sm:px-6 sm:py-6">
