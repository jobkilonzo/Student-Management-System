...
const RegistrarExamTimetableTechnical = () => {
  ...
  const loadLatest = async () => {
    ...
    try {
      const res = await makeRequest.get(`/exams/timetable/technical`, {
  ...
  const generate = async (e) => {
    ...
    try {
      ...
      const res = await makeRequest.post(`/exams/timetable/technical`, payload);
...
export default RegistrarExamTimetableTechnical;
